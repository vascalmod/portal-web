...
export const DURATION_PRESETS: { label: string; secs: number | null }[] = [
  ...
  { label: "₱10 — 16 Hours", secs: 57600 },
  { label: "₱20 — 36 Hours (1.5 Days)", secs: 129600 },
  { label: "₱50 — 4 Days (96 Hours)", secs: 345600 },
  { label: "₱100 — 9 Days", secs: 777600 },
  { label: "₱200 — 19 Days", secs: 1641600 },
  { label: "₱500 — 30 Days (1 Month)", secs: 2592000 },
